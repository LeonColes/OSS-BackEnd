...
// CasbinMiddleware RBAC权限中间件
type CasbinMiddleware struct {
	casbinService service.CasbinService
}

// NewCasbinMiddleware 创建Casbin中间件
func NewCasbinMiddleware(casbinService service.CasbinService) *CasbinMiddleware {
	return &CasbinMiddleware{
		casbinService: casbinService,
	}
}

// AuthCheckForSystem 系统级权限验证中间件
func (m *CasbinMiddleware) AuthCheckForSystem() gin.HandlerFunc {
...
// AuthCheckForGroup 群组级权限验证中间件
func (m *CasbinMiddleware) AuthCheckForGroup() gin.HandlerFunc {
	return func(c *gin.Context) {
		// 从上下文获取用户ID
...
// AuthCheckForProject 项目级权限验证中间件
func (m *CasbinMiddleware) AuthCheckForProject() gin.HandlerFunc {
	return func(c *gin.Context) {
		// 从上下文获取用户ID
		userIDValue, exists := c.Get("userID")
		if !exists {
